...
<form:form method="post" modelAttribute="motorization">
 <table>
 <tbody>
 <tr><td><label for="title">Tytul:</label></td>
 ...
 <tr>
  ...
  <td><form:select path="brand" ><form:option value="Audi"></form:option><form:option value="BMW"></form:option><form:option value="Mercedes"></form:option></form:select></td>
 </tr>
 <tr><td><label for"type">Rodzaj nadwozia:</label></td><td><form:select path="type"><form:option value="kombi"></form:option><form:option value="sedan"></form:option></form:select></td></tr>
 <td>
