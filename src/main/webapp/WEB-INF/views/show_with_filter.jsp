...
<form:option value="wszystkie"></form:option><form:option value="czerwony">czerwony</form:option>
<form:option value="zielony">zielony</form:option></form:select></td></tr>
...
<h1>${listOfMotorization.title}</h1><br/><h4>${listOfMotorization.description}</h4><br/><p>Rok produkcji :</p>
<h3>${listOfMotorization.year}</h3>
